package com.devsuperior.CrudClient.controllers.handlers;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> resourceNotFound(ResourcesNotFoundException e, HttpServletRequest request) {
